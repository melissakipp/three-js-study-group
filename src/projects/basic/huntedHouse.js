...
// Canvas
const canvas = document.querySelector('canvas.hunted')
...
const floorColorTexture = textureLoader.load('/textures/floor/brownMudLeaves/brown_mud_leaves_01_diff_1k.jpg')
const floorARMTexture = textureLoader.load('/textures/floor/brownMudLeaves/brown_mud_leaves_01_arm_1k.jpg') 
const floorNormalTexture = textureLoader.load('/textures/floor/brownMudLeaves/brown_mud_leaves_01_nor_gl_1k.jpg') 
const floorDisplacementTexture = textureLoader.load('/textures/floor/brownMudLeaves/brown_mud_leaves_01_disp_1k.jpg')
...
// Wall
const wallColorTexture = textureLoader.load('/textures/wall/wood_peeling_paint_weathered/wood_peeling_paint_weathered_diff_1k.jpg')
const wallARMTexture = textureLoader.load('/textures/wall/wood_peeling_paint_weathered/wood_peeling_paint_weathered_arm_1k.jpg')
const wallNormalTexture = textureLoader.load('/textures/wall/wood_peeling_paint_weathered/wood_peeling_paint_weathered_nor_gl_1k.jpg')

wallColorTexture.colorSpace = THREE.SRGBColorSpace

// Roof
const roofColorTexture = textureLoader.load('/textures/roof/thatch_roof_angled/thatch_roof_angled_diff_1k.jpg')
const roofARMTexture = textureLoader.load('/textures/roof/thatch_roof_angled/thatch_roof_angled_arm_1k.jpg')
const roofNormalTexture = textureLoader.load('/textures/roof/thatch_roof_angled/thatch_roof_angled_nor_gl_1k.jpg')
...
const floor = new THREE.Mesh(
    new THREE.PlaneGeometry(20, 20, 110, 110),
...
// Door light
const doorLight = new THREE.PointLight('#f0ffcc', 5)
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#ddffff', 6)
